<%@ Page Title="" Language="C#" MasterPageFile="~/SiteGSS.Master" AutoEventWireup="true" CodeBehind="CaptureGasSales.aspx.cs" Inherits="BudgetCapture.GSS.CaptureGasSales" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row-fluid">
     <div class=" span12 pageheader-text">Capture Gas Sales Data</div>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Input Gas Sales Data</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Sales detail :</div>
        ...
        <div class="controls">
           ...
           <%-- <asp:TextBox ID="txtSearchCust" runat="server" CssClass=""></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"  runat="server" ForeColor=Maroon ControlToValidate="txtSearchCust" Display="Dynamic" Text="Required!"></asp:RequiredFieldValidator>
            <asp:AutoCompleteExtender ServiceMethod="SearchCustomers" MinimumPrefixLength="2" CompletionInterval="50" EnableCaching="false" CompletionSetCount="10"
           TargetControlID="txtSearchCust" ID="AutoCompleteExtender1" runat="server" FirstRowSelected = "false">
         </asp:AutoCompleteExtender>--%>
             </div> 
        </div>
        <div class="control-group">
        <label class="control-label" for="txtStaffID">Sales Date<span>*</span>:</label>
        <div class="controls">
        ...
        <div class="control-group">
        <label class="control-label" for="txtStaffID">Sales Volume<span>*</span>:</label>
        <div class="controls">
...
<div class="row-fluid">
 ...
 <div class="inner-header">My Unapproved Sales Data
    ...
    <asp:GridView ID="gvCommon" runat="server" GridLines="None"  Font-Size="11px" 
      ...
      <Columns>
        ...
        <asp:CommandField ButtonType="Image" HeaderText="Edit" ShowSelectButton="true" SelectImageUrl="../img/edit_icon.png"   />
         <asp:TemplateField>
        <ItemTemplate>
             <asp:ImageButton ID="imgBtnDel" CommandName="del" CommandArgument='<%#Eval("ID") %>' CausesValidation="false" ToolTip="Delete Item" runat="server"  ImageUrl="~/img/delete-icon.png" />
         </ItemTemplate>
         </asp:TemplateField>
      </Columns>
