...
{
    public partial class PendingCapturedGasSales : System.Web.UI.Page
    {
        ...
        private void BindGrid(DateTime filter, int cust = 0)
        {
            ...
            gvCommon.DataSource = GasSalesBLL.GetGasSalesList((int)Utility.SalesStatus.Pending_Capture_Approval, filter, cust);
            gvCommon.DataBind();
        }
