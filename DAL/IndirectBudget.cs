...
namespace BudgetCapture.DAL
{
    ...
    public partial class IndirectBudget
    {
        public int ID { get; set; }
        public Nullable<int> IndirectItemID { get; set; }
        ...
        public Nullable<decimal> ATCOutstandingAmount { get; set; }
    
        public virtual BudgetYear BudgetYear { get; set; }
        public virtual Department Department { get; set; }
        public virtual IndirectBudgetItem IndirectBudgetItem { get; set; }
    }
}
