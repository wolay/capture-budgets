<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewHireRpt.aspx.cs" Inherits="BudgetCapture.Reports.NewHireRpt" %>
             ...
             <tr>
              <td colspan="2">
                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Width="100%"
                      ...
                      <localreport reportpath="Reports\NewHireRpt.rdlc">
                          <datasources>
