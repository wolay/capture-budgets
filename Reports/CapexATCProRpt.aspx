<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapexATCProRpt.aspx.cs" Inherits="BudgetCapture.Reports.CapexATCProRpt" %>
...
<head runat="server">
    <title>BugetCapture:: Capex ATC Report</title>
</head>
<body>
     ...
     <tr>
          ...
          <div style="border-top: black 1px solid; background-color: #ece9d8; border-bottom-width: 1px; border-bottom-color: #d4d0c8; padding-bottom: 10px; margin-bottom:0px;">
           <table width="100%" style="padding:2px;font-family:Arial, Helvetica, sans-serif;color:#5b5b5b;font-size:11px;">
            ...
            <td>
               <asp:DropDownList Id="ddlDept" runat="server" CssClass="" Font-Size="11px" 
             ...
             <tr>
              <td colspan="2">
                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Width="100%" Height="100%"
                      ...
                      <localreport reportpath="Reports\CapexATCRpt.rdlc">
                          <datasources>
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                      ...
                      TypeName="BudgetCapture.Reports.dsBudgetRptTableAdapters.bc_rpt_CapexATCTableAdapter">
                      <SelectParameters>
