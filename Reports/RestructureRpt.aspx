<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RestructureRpt.aspx.cs" Inherits="BudgetCapture.Reports.RestructureRpt" %>
...
<head runat="server">
    <title>BugetCapture:: Restructure Projection Report</title>
</head>
<body>
             ...
             <tr>
              <td colspan="2">
                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Width="100%" Height="100%"
                      ...
                      <localreport reportpath="Reports\RestructureRpt.rdlc">
                          <datasources>
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                      ...
                      TypeName="BudgetCapture.Reports.dsBudgetRptTableAdapters.bc_rpt_RestructureProTableAdapter">
                      <SelectParameters>
