<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapexProRpt.aspx.cs" Inherits="BudgetCapture.Reports.CapexProRpt" %>
             ...
             <tr>
              <td colspan="2">
                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Width="100%" Height="100%"
                      ...
                      <localreport reportpath="Reports\CapexRpt.rdlc">
                          <datasources>
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                      ...
                      TypeName="BudgetCapture.Reports.dsBudgetRptTableAdapters.bc_rpt_CapexTableAdapter">
                      <SelectParameters>
