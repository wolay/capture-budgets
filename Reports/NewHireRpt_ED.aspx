<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewHireRpt_ED.aspx.cs" Inherits="BudgetCapture.Reports.NewHireRpt_ED" %>
...
<head runat="server">
    <title>BugetCapture:: New Hire Budget ED Report</title>
</head>
<body>
        ...
        <td>
            <table width="100%" cellpadding="0" cellspacing="0" border="0" >
             <tr>
              ...
              <td style="padding:5px;font-family:Arial, Helvetica, sans-serif;color:#5b5b5b;font-size:11px;"><a href="../Default.aspx">DashBoard </a> | 
                  <a href="ReportHome.aspx">Report</a></td>
             </tr>
             </table>
          </td>
     </tr>
          ...
          <div style="border-top: black 1px solid; background-color: #ece9d8; border-bottom-width: 1px; border-bottom-color: #d4d0c8; padding-bottom: 10px; margin-bottom:0px;">
           <table width="100%" style="padding:2px;font-family:Arial, Helvetica, sans-serif;color:#5b5b5b;font-size:11px;">
            <tr>
             ...
             <asp:DropDownList ID="ddlbudyr" runat="server" AppendDataBoundItems="true" Width="310px">
            ...
            <td>
               <asp:DropDownList Id="ddlDir" runat="server" CssClass="" 
                 ...
                 <asp:ListItem Value="" Selected="True">..Select Directorate..</asp:ListItem>
             </asp:DropDownList>
            </td>
            </tr>
            <tr>
             ...
             <tr>
              <td colspan="2">
                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Width="100%" Height="100%"
                      ...
                      <localreport reportpath="Reports\NewHireRpt_ED.rdlc">
                          <datasources>
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                      ...
                      TypeName="BudgetCapture.Reports.dsBudgetRptTableAdapters.bc_rpt_NewHireTableAdapter">
                      <SelectParameters>
                          <asp:Parameter Name="directorateID" Type="Int32" />
