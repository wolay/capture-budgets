<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageDirectorate.aspx.cs" Inherits="BudgetCapture.Admin.ManageDirectorate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div class="row-fluid">
     <div class=" span12 pageheader-text">Manage Directorate Page</div>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Setup Directorate</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Directorate :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Directorate</div>
    ...
    <asp:GridView ID="gvDir" runat="server" GridLines="None" Font-Size="11px" 
      ...
      <Columns>
        ...
        <asp:BoundField HeaderText="Directorate" DataField="Name" />
