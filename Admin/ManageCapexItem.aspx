<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageCapexItem.aspx.cs" Inherits="BudgetCapture.Admin.ManageCapexItem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div class="row-fluid">
     <div class=" span12 pageheader-text">Manage Capex Items  Page</div>
  ...
  <div class="inner-header">Setup Capex Expense Item</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Capex Item :</div>
        ...
        <label class="control-label" for="txtStaffID">Capex Type:<span>*</span>:</label>
        <div class="controls">
            <asp:DropDownList ID="ddlDir" runat="server" AppendDataBoundItems="true">
             <asp:ListItem Value="">...Select CapexType...</asp:ListItem>
            </asp:DropDownList>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Capex Item
       ...
       <%-- <asp:BoundField HeaderText="Code" DataField="Code" />--%>
        ...
        <asp:TemplateField HeaderText="Capex Type">
             ...
             <asp:Label ID="lbID" runat="server" Text='<%#Eval("ID") %>' Visible="false"></asp:Label>
                  <asp:Label ID="lbDir" runat="server" Text='<%#Eval("CapexType.ID") %>' Visible="false"></asp:Label>
                 <asp:Label ID="lbloc1" runat="server" Text='<%#Eval("CapexType.Name") %>'></asp:Label>
             </ItemTemplate>
           </asp:TemplateField>
