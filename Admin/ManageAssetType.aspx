<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageAssetType.aspx.cs" Inherits="BudgetCapture.Admin.ManageAssetType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div class="row-fluid">
     <div class=" span12 pageheader-text">Manage Movable AssetType Page</div>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Setup Movable Type</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New AssetType :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Asset Type</div>
