<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageCapexType.aspx.cs" Inherits="BudgetCapture.Admin.ManageCapexType" %>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Setup Capex Type</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New CapexType :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Capex Expense Type</div>
