<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReinvestmentPage.aspx.cs" Inherits="BudgetCapture.ReinvestmentPage" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row-fluid">
     <div class=" span12 pageheader-text">Reinvestment Projection Page</div>
...
<div class="alert alert-info">
    <span>Enter your projected volumes for Treasury Bills and placements for the Budget Year.All figures should be in thousands (N'000)</span>
  </div>
  <fieldset>
          <div id="legend">
            </div>
        ...
        <label class="control-label" for="txtStaffID">Reinvestment Type <span>*</span>:</label>
        <div class="controls">
              <asp:DropDownList ID="ddlCat" runat="server" AppendDataBoundItems="true" Font-Size="12px">
             <asp:ListItem Value="">...Select Reinvestment...</asp:ListItem>
            </asp:DropDownList>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Reinvestment Projection
    <div class="form-horizontal" style="float:right;margin-top:-5px">
            <div class="controls-group">
            <div class="controls">
                     <asp:DropDownList ID="ddlReinvestTyp" runat="server" AppendDataBoundItems="true" Font-Size="12px">
             <asp:ListItem Value="" Selected="True">...Filter By Type...</asp:ListItem>
            </asp:DropDownList>
    ...
    <asp:GridView ID="gvDept" runat="server" GridLines="None"  Font-Size="11px" ShowFooter="true"
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Reinvestment Type">
             <ItemTemplate>
              <asp:Label ID="lbRecID" runat="server" Text='<%#Eval("ID") %>' Visible="false"></asp:Label>
              <asp:Label ID="lbID" runat="server" Text='<%#Eval("ReinvestmentType.ID") %>' Visible="false"></asp:Label>
                 <asp:Label ID="lbloc1" runat="server" Text='<%#Eval("ReinvestmentType.Name") %>'></asp:Label>
             </ItemTemplate>
              <FooterTemplate>
                <asp:Label ID="lbTot" runat="server" Text="Net Reinvestment"></asp:Label>
             </FooterTemplate>
           </asp:TemplateField>
