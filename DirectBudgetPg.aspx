<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DirectBudgetPg.aspx.cs" Inherits="BudgetCapture.DirectBudgetPg" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row-fluid">
     <div class=" span12 pageheader-text">Direct Expense Projection Page</div>
...
<div class="alert alert-info">
  ...
  <fieldset>
        ...
        <label class="control-label" for="txtStaffID">Direct
        ...
        <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Select Direct Type...</asp:ListItem>
            </asp:DropDownList>
        ...
        <div class="control-group">
        <label class="control-label" for="txtStaffID">Direct ExpenseItem <span>*</span>:</label>
        <div class="controls">
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Projected Direct Expense
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Department">
             <ItemTemplate>
              ...
              <asp:Label ID="lbID" runat="server" Text='<%#Eval("DirectExpenseItem.DirectTypeID") %>' Visible="false"></asp:Label>
          ...
          <%--  <asp:TemplateField HeaderText="Direct Type">
            <ItemTemplate>
                 <asp:Label ID="lbAsstTyp" runat="server" Text='<%#Eval("DirectExpenseItem.DirectType.Name") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>--%>
          <asp:TemplateField HeaderText="Direct Item">
            <ItemTemplate>
                 <asp:Label ID="lbAsst" runat="server" Text='<%#Eval("DirectExpenseItem.Name") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>
