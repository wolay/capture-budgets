<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RestructureProjectionPage.aspx.cs" Inherits="BudgetCapture.RestructureProjectionPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
         <ContentTemplate>
    <div class="row-fluid">
     <div class=" span12 pageheader-text">Restructure Projection Page</div>
...
<div class="alert alert-info">
    <span>List Top 20 Obligors and the amounts against the month concerned."Others" should not exceeed 20% of Total.All figures should be in thousands (N'000) </span>
    <li>Budget Year: 
  ...
  <fieldset>
     ...
     <div id="dvSingle" runat="server" visible="false">
      <div class="control-group">
        <label class="control-label" for="txtStaffID">Enter Obligor AgreementNo: <span>*</span>:</label>
        <div class="controls">
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Obligor to Restructure
      <div class="form-horizontal" runat="server" id="dvAdminScr" visible="false"  style="float:right;margin-top:-5px">
            ...
            <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Filter By LoanType...</asp:ListItem>
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Loan Type">
         <ItemTemplate>
          ...
          <asp:TemplateField HeaderText="Obligor">
            <ItemTemplate>
             <asp:Label ID="lbRecID" runat="server" Text='<%#Eval("ID") %>' Visible="false"></asp:Label>
                 <asp:Label ID="lbOblig" runat="server" Text='<%#Eval("ObligorName") %>'></asp:Label>
             </ItemTemplate>
              <FooterTemplate>
                <asp:Label ID="lbTot" runat="server" Text="Total Restructure"></asp:Label>
             </FooterTemplate>
          </asp:TemplateField>
