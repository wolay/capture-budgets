<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MovableAsset.aspx.cs" Inherits="BudgetCapture.Capex" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row-fluid">
     <div class=" span12 pageheader-text">Movable Asset Projection Page</div>
...
<div class="alert alert-info">
  ...
  <fieldset>
        ...
        <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Select Asset Type...</asp:ListItem>
            </asp:DropDownList>
        ...
        <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Select Asset...</asp:ListItem>
            </asp:DropDownList>
       ...
       <%--<div class="control-group">
        ...
        <div class="control-group">
        <label class="control-label" for="txtStaffID">Quantity<span>*</span>:</label>
        <div class="controls">
        ...
        <div class="controls">
            <asp:TextBox ID="txtJust" runat="server" CssClass="" TextMode="MultiLine" Rows="3"></asp:TextBox>    
        </div>
        </div>
       <%-- <div class="control-group">
        <label class="control-label" for="txtStaffID">Existing Quantity<span></span>:</label>
        <div class="controls">
            <asp:TextBox ID="txtExtQty" runat="server" CssClass=""></asp:TextBox>    
        </div>
        </div>--%>
       <div class="control-group">
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Projected Movable Asset
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Department">
             <ItemTemplate>
              ...
              <asp:Label ID="lbID" runat="server" Text='<%#Eval("Asset.AssetType.ID") %>' Visible="false"></asp:Label>
                 <asp:Label ID="lbloc1" runat="server" Text='<%#Eval("Department.Name") %>'></asp:Label>
             </ItemTemplate>
             <FooterTemplate>
                <asp:Label ID="lbTot" runat="server" Text="GrandTotal"></asp:Label>
             </FooterTemplate>
           </asp:TemplateField>
           <%-- <asp:TemplateField HeaderText="AssetType">
            <ItemTemplate>
                 <asp:Label ID="lbAsstTyp" runat="server" Text='<%#Eval("Asset.AssetType.Name") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>--%>
          <asp:TemplateField HeaderText="Asset">
            <ItemTemplate>
                 <asp:Label ID="lbAsst" runat="server" Text='<%#Eval("Asset.AssetName") %>' Width="80px"></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>
          ...
          <%-- <asp:BoundField HeaderText="Quantity" DataField="Quantity"/>  --%>
           <asp:TemplateField HeaderText="Quantity">
            <ItemTemplate>
             ...
             <FooterTemplate>
                <asp:Label ID="lbSumQty" runat="server" Text=""></asp:Label>
             </FooterTemplate>
          </asp:TemplateField>
           <asp:TemplateField HeaderText="Unit Price(N'million)">
            <ItemTemplate>
                 <asp:Label ID="lbAsstPRice" runat="server" Text='<%#Eval("Asset.UnitPrice","{0:N}") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>
