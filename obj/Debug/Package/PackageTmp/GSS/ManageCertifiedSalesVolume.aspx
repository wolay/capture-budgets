<%@ Page Title="" Language="C#" MasterPageFile="~/SiteGSS.Master" AutoEventWireup="true" CodeBehind="ManageCertifiedSalesVolume.aspx.cs" Inherits="BudgetCapture.GSS.ManageCertifiedSalesVolume" %>
  ...
  <div class="inner-header">Search Criterias</div>
    ...
    <%--<div class="nav-header" runat="server" id="dvMsg">Add New Pipeline Section :</div>--%>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <asp:Button ID="Button1" runat="server" Text="Filter Record" 
    ...
    <asp:HiddenField ID="hid" runat="server" />
     <asp:GridView ID="gvCommon" runat="server" GridLines="None"  Font-Size="11px" EmptyDataText="No record found" 
      ...
      <Columns>
        ...
        <ItemTemplate>
             <asp:ImageButton ID="imgBtnEdt" CommandName="edt" Visible="false" CommandArgument='<%#Eval("ID") %>' CausesValidation="false" ToolTip="View Item" runat="server"  ImageUrl="~/img/view-icon.png" />
         </ItemTemplate>
         </asp:TemplateField>
