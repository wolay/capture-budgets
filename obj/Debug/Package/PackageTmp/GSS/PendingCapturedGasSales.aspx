<%@ Page Title="" Language="C#" MasterPageFile="~/SiteGSS.Master" AutoEventWireup="true" CodeBehind="PendingCapturedGasSales.aspx.cs" Inherits="BudgetCapture.GSS.PendingCapturedGasSales" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row-fluid">
     <div class=" span12 pageheader-text">Unapproved Capture Gas Sales Data</div>
    ...
    <asp:GridView ID="gvCommon" runat="server" GridLines="None"  Font-Size="11px" EmptyDataText="No record found" 
      ...
      <Columns>
        ...
        <asp:BoundField HeaderText="Date Captured" DataField="DateCaptured" DataFormatString="{0:dd-MMM-yyyy}"/>
          <asp:TemplateField HeaderText="Captured By">
            <ItemTemplate>
                 <asp:Label ID="lbfName" runat="server" Text='<%#Eval("AppUser.FullName")%>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>
