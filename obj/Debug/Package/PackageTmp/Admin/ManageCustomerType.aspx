<%@ Page Title="" Language="C#" MasterPageFile="~/SiteGSS.Master" AutoEventWireup="true" CodeBehind="ManageCustomerType.aspx.cs" Inherits="BudgetCapture.Admin.ManageCustomerType" %>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Setup Customer Type</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New CustomerType :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Customer Type
 </div>
