<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageGrades.aspx.cs" Inherits="BudgetCapture.Admin.ManageGrades" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row-fluid">
     <div class=" span12 pageheader-text">Manage Grade Page</div>
...
<div class="page-body span12">
  ...
  <div class="inner-header">Setup Grade</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Grade :</div>
       ...
       <%-- <div class="control-group">
        <label class="control-label" for="txtStaffID">Cost Per Month(=N=)<span>*</span>:</label>
        <div class="controls">
            <asp:TextBox ID="txtCostMth" runat="server" CssClass=""></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"  runat="server" ForeColor=Maroon ControlToValidate="txtCostMth" Display="Dynamic" Text="Required!"></asp:RequiredFieldValidator>  
        </div>
        </div>--%>
        <%--<div class="control-group">
        <label class="control-label" for="txtStaffID">Cost Per Year(=N=)<span>*</span>:</label>
        <div class="controls">
            <asp:TextBox ID="txtCostYr" runat="server" CssClass=""></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"  runat="server" ForeColor=Maroon ControlToValidate="txtCostYr" Display="Dynamic" Text="Required!"></asp:RequiredFieldValidator>  
        </div>
        </div>--%>
        <div class="control-group">
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Grade</div>
    ...
    <asp:GridView ID="gvDir" runat="server" GridLines="None" Font-Size="11px" 
        AutoGenerateColumns="false" CssClass="table table-striped" DataKeyNames="ID" 
           AllowPaging="true" PageIndex="0" PageSize="100" EmptyDataText="No Record Found"
