<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CapexBudgetPg.aspx.cs" Inherits="BudgetCapture.CapexBudgetPg" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row-fluid">
     <div class=" span12 pageheader-text">Capex Expense Projection Page</div>
...
<div class="alert alert-info">
  ...
  <fieldset>
        ...
        <label class="control-label" for="txtStaffID">Capex
        ...
        <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Select Capex Type...</asp:ListItem>
            </asp:DropDownList>
        ...
        <div class="control-group">
        <label class="control-label" for="txtStaffID">Capex ExpenseItem <span>*</span>:</label>
        <div class="controls">
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Projected Capex Expense
    <div class="form-horizontal" style="float:right;margin-top:-5px" runat="server" id="dvFilterHeader">
            ...
            <div class="controls">
             ...
             <asp:ListItem Value="" Selected="True">...Filter By CapexType...</asp:ListItem>
            </asp:DropDownList>
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Department">
             <ItemTemplate>
              ...
              <asp:Label ID="lbID" runat="server" Text='<%#Eval("CapexExpenseItem.CapexTypeID") %>' Visible="false"></asp:Label>
            ...
            <%--<asp:TemplateField HeaderText="Capex Type">
            <ItemTemplate>
                 <asp:Label ID="lbAsstTyp" runat="server" Text='<%#Eval("CapexExpenseItem.CapexType.Name") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>--%>
          <asp:TemplateField HeaderText="Capex Item">
            <ItemTemplate>
                 <asp:Label ID="lbAsst" runat="server" Text='<%#Eval("CapexExpenseItem.Name") %>'></asp:Label>
             </ItemTemplate>
          </asp:TemplateField>
